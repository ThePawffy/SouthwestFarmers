...
class SettingController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $general->update([
            'value' => $request->except('_token','_method','favicon','admin_logo', 'business_logo') + [
                    ...
                    'business_logo' => $request->business_logo ? $this->upload($request, 'business_logo', $general->value['business_logo'] ?? null) : ($general->value['business_logo'] ?? null)
                ]
        ]);
