...
class SslCommerzNotification extends AbstractSslCommerz
{
    ...
    public function __construct($gateway, $success_url, $failed_url)
    {
        ...
        $apiDomain = $gateway->mode == 'Sandbox' ? "https://sandbox.sslcommerz.com" : "https://securepay.sslcommerz.com";
        $this->config = [
            'apiCredentials' => [
            ...
            'apiDomain' => $apiDomain,
            'connect_from_localhost' => $gateway->mode, // For Sandbox, use "true", For Live, use "false"
