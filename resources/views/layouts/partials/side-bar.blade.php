<nav class="side-bar">
    <div class="side-bar-logo admin-logo">
    ...
    <div class="side-bar-manu">
        <ul>
            ...
            <li class="dropdown {{ Route::is('admin.website-settings.index', 'admin.features.index', 'admin.features.create', 'admin.features.edit', 'admin.blogs.index', 'admin.comments.index', 'admin.testimonials.index', 'admin.interfaces.index', 'admin.term-conditions.index', 'admin.privacy-policy.index', 'admin.blogs.filter.comment', 'admin.testimonials.create', 'admin.testimonials.edit', 'admin.interfaces.create', 'admin.interfaces.edit', 'admin.blogs.create', 'admin.blogs.edit', 'admin.messages.index', 'admin.faqs.index', 'admin.tutorials.index', 'admin.tutorials.index') ? 'active' : '' }}">
                ...
                <ul>
                    ...
                    @can('blogs-read')
                    <li>
                        <a class="{{ Request::routeIs('admin.blogs.index', 'admin.blogs.filter.comment', 'admin.blogs.create', 'admin.blogs.edit') ? 'active' : '' }}" href="{{ route('admin.blogs.index') }}">{{ __('Blogs') }}</a>
                    </li>
                    @endcan
                    ...
                    <li>
                        <a class="{{ Request::routeIs('admin.interfaces.index', 'admin.interfaces.create', 'admin.interfaces.edit') ? 'active' : '' }}" href="{{ route('admin.interfaces.index') }}">{{ __('Interfaces') }}</a>
                    </li>
                    ...
                    <li>
                        <a class="{{ Request::routeIs('admin.messages.index') ? 'active' : '' }}" href="{{ route('admin.messages.index') }}">{{ __('Messages') }}</a>
                    </li>

                    <li>
                        <a class="{{ Request::routeIs('admin.tutorials.index') ? 'active' : '' }}" href="{{ route('admin.tutorials.index') }}">{{ __('Tutorials') }}</a>
                    </li>

                    <li>
                        <a class="{{ Request::routeIs('admin.faqs.index') ? 'active' : '' }}" href="{{ route('admin.faqs.index') }}">{{ __('Faqs') }}</a>
                    </li>
        ...
        <li class="{{ Request::routeIs('admin.addons.index') ? 'active' : '' }}">
            ...
            @canany(['settings-read', 'notifications-read', 'currencies-read', 'gateways-read','login-pages-read'])
                <li class="dropdown {{ Request::routeIs('admin.settings.index', 'admin.notifications.index', 'admin.system-settings.index', 'admin.currencies.index', 'admin.currencies.create', 'admin.currencies.edit', 'admin.sms-settings.index', 'admin.gateways.index', 'admin.login-pages.index') ? 'active' : '' }}">
                    <a href="#">
                        <span class="sidebar-icon">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
