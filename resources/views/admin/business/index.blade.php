...
@push('modal')
    ...
    {{--business view modal --}}
    <div class="modal fade common-validation-modal" id="business-view-modal">
                ...
                <div class="modal-body">
                    <div class="personal-info">
                        ...
                        <div class="row align-items-center mt-4">
                            <div class="col-5"><p>{{ __('Business Name') }}</p></div>
                            <div class="col-1">
                                <p>:</p>
                            </div>
                            <div class="col-6"><p class="business_name"></p></div>
                        </div>

                        <div class="row align-items-center mt-3">
                            <div class="col-5"><p>{{ __('Business Category') }}</p></div>
                            <div class="col-1">
                                <p>:</p>
                            </div>
                            <div class="col-6"><p id="category"></p></div>
                        </div>
                        <div class="row align-items-center mt-3">
                            <div class="col-5"><p>{{ __('Phone') }}</p></div>
                            <div class="col-1">
                                <p>:</p>
                            </div>
                            <div class="col-6"><p id="phone"></p></div>
                        </div>
                        <div class="row align-items-center mt-3">
                            <div class="col-5"><p>{{ __('Address') }}</p></div>
                            <div class="col-1">
                                <p>:</p>
                            </div>
                            <div class="col-6"><p id="address"></p></div>
                        </div>
                        <div class="row align-items-center mt-3">
                            <div class="col-5"><p>{{ __('Package') }}</p></div>
                            <div class="col-1">
                                <p>:</p>
                            </div>
                            <div class="col-6"><p id="package"></p></div>
                        </div>
                        <div class="row align-items-center mt-3">
                            <div class="col-5"><p>{{ __('Upgrade Date') }}</p></div>
                            <div class="col-1">
                                <p>:</p>
                            </div>
                            <div class="col-6"><p id="last_enroll"></p></div>
                        </div>
                        <div class="row align-items-center mt-3">
                            <div class="col-5"><p>{{ __('Expired Date') }}</p></div>
                            <div class="col-1">
                                <p>:</p>
                            </div>
                            <div class="col-6"><p id="expired_date"></p></div>
                        </div>
                        <div class="row align-items-center mt-3">
                            <div class="col-5"><p>{{ __('Created date') }}</p></div>
                            <div class="col-1">
                                <p>:</p>
                            </div>
                            <div class="col-6"><p id="created_date"></p></div>
                        </div>
                    </div>
                </div>
            </div>
