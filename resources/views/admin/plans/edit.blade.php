                                                    ...
                                                    @foreach ($plan->features ?? [] as $key => $item)
                                                        <div class="feature-item">
                                                            <div class="form-control m-0 d-flex justify-content-between align-items-center">
                                                                <input type="text" name="features[features_{{ $key }}][]"
                                                                    value="{{ $item[0] ?? '' }}" placeholder="Enter Extra feature"
                                                                    class="add-feature-{{ $key }} extra-feature-input">
                                                                    ...
                                                                    <div class="d-flex align-items-center gap-4">
                                                                        ...
                                                                        <svg class="delete-feature" width="20" height="22"
                                                                            viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                            <path
                                                                                d="M2.5 5.58342H17.5M13.3796 5.58342L12.8107 4.40986C12.4328 3.6303 12.2438 3.24051 11.9179 2.99742C11.8457 2.9435 11.7691 2.89553 11.689 2.854C11.3281 2.66675 10.8949 2.66675 10.0286 2.66675C9.1405 2.66675 8.6965 2.66675 8.32957 2.86185C8.24826 2.90509 8.17066 2.955 8.09758 3.01106C7.76787 3.264 7.5837 3.66804 7.21535 4.47613L6.71061 5.58342"
                                                                                stroke="#F54336" stroke-width="1.5" stroke-linecap="round" />
                                                                            <path
                                                                                d="M16.25 5.5835L15.7336 13.9377C15.6016 16.0722 15.5357 17.1394 15.0007 17.9067C14.7361 18.2861 14.3956 18.6062 14.0006 18.8468C13.2017 19.3335 12.1325 19.3335 9.99392 19.3335C7.8526 19.3335 6.78192 19.3335 5.98254 18.8459C5.58733 18.6049 5.24667 18.2842 4.98223 17.9042C4.4474 17.1357 4.38287 16.0669 4.25384 13.9295L3.75 5.5835"
                                                                                stroke="#F54336" stroke-width="1.5" stroke-linecap="round" />
                                                                            <path d="M7.5 10.7717H12.5" stroke="#F54336" stroke-width="1.5"
                                                                                stroke-linecap="round" />
                                                                            <path d="M8.75 14.1467H11.25" stroke="#F54336" stroke-width="1.5"
                                                                                stroke-linecap="round" />
                                                                        </svg>
                                                                    </div>
                                                            </div>
