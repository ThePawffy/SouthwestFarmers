                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 settings-image-upload">
                                        ...
                                        <div class="upload-img-v2">
                                             <label class="upload-v4 settings-upload-v4">
                                                <div class="img-wrp">
                                                    <img src="{{ asset($login_page->value['login_page_icon'] ?? 'assets/images/icons/upload-icon.svg') }}" id="login_page_icon"  alt="Preview Image">
                                                </div>
                                                <input
                                                    type="file"
                                                    name="login_page_icon"
                                                    class="d-none form-control"
                                                    id="login_page_icon"
                                                    data-preview="login_page_icon"
                                                    accept="image/*"
                                                >
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-lg-6 settings-image-upload">
                                        ...
                                        <div class="upload-img-v2">
                                             <label class="upload-v4 settings-upload-v4">
                                                <div class="img-wrp">
                                                    <img src="{{ asset($login_page->value['login_page_image'] ?? 'assets/images/icons/upload-icon.svg') }}" id="login_page_image"  alt="Preview Image">
                                                </div>
                                                <input
                                                    type="file"
