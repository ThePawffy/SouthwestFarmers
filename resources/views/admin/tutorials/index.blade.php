            ...
            <div class="card">
                <div class="card-bodys">
                    ...
                    <div class="table-header p-16">
                        ...
                        <a type="button" href="#tutorial-create-modal" data-bs-toggle="modal"
                            class="add-order-btn rounded-2 {{ Route::is('admin.tutorials.create') ? 'active' : '' }}"
                            class="btn btn-primary"><i class="fas fa-plus-circle me-1"></i>{{ __('Add new') }}</a>
                    </div>

                    <div class="table-top-form p-16-0">
                        <form action="{{ route('admin.tutorials.filter') }}" method="post" class="filter-form"
                            table="#faqs-data">
                            @csrf
                    ...
                    <table class="table bg-striped" id="datatable">
                        <thead>
                            <tr>
                                ...
                                <th class='striped-th'> {{ __('Thumbnail') }} </th>
                                <th class='striped-th'> {{ __('Title') }} </th>
                                <th class='striped-th'> {{ __('Url') }} </th>
                                <th class='striped-th'> {{ __('Status') }} </th>
                                <th class='striped-th'> {{ __('Action') }} </th>
                            </tr>
                        </thead>
                        <tbody id="faqs-data">
                            @include('admin.tutorials.datas')
                        </tbody>
                    </table>
                </div>
...
@push('modal')
    ...
    @include('admin.tutorials.create')
    @include('admin.tutorials.edit')
@endpush
