            ...
            <div class="card">
                <div class="card-bodys">
                    ...
                    <div class="table-header p-16">
                        <h4>{{ __('Faq List') }}</h4>
                        <a type="button" href="#faq-create-modal" data-bs-toggle="modal" class="add-order-btn rounded-2 {{ Route::is('admin.faqs.create') ? 'active' : '' }}" class="btn btn-primary"><i class="fas fa-plus-circle me-1"></i>{{ __('Add new') }}</a>
                    </div>

                    <div class="table-top-form p-16-0">
                        <form action="{{ route('admin.faqs.filter') }}" method="post" class="filter-form"
                            table="#faqs-data">
                            @csrf
