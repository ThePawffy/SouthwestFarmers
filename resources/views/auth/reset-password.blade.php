...
<div class="footer">
    <div class="footer-logo w-100 mx-4">
        <img src="{{ asset($login_page->value['login_page_icon'] ?? 'assets/images/icons/logo.svg') }}" alt="">
    </div>
    <div class="mybazar-login-section">
         <div class="mybazar-login-avatar">
            <img src="{{ asset($login_page->value['login_page_image'] ?? 'assets/images/icons/login-img.svg') }}" alt="">
        </div>
