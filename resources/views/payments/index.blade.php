                                ...
                                <div class="payment-list-table">
                                    ...
                                    <table class="table table-striped">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="payment-td">{{ __('Gateway Name') }}</td>
                                                <td class="text-start">{{ $gateway->name }}</td>
                                            </tr>
                                            <tr>
                                                <td class="payment-td">{{ __('Gateway Rate') }}</td>
                                                <td class="text-start">{{ '$1 = ' . currency_format($gateway->currency->rate, currency:$gateway->currency) }}</td>
                                            </tr>
                                            <tr>
                                                <td class="payment-td">{{ __('Subscription Name') }}</td>
                                                <td class="text-start">{{ $plan->subscriptionName }}</td>
                                            </tr>
                                            <tr>
                                                <td class="payment-td">{{ __('Subscription Price') }}</td>
                                                <td class="text-start">{{ currency_format($amount, currency : $gateway->currency) }}</td>
                                            </tr>
                                            <tr>
                                                <td class="payment-td">{{ __('Gateway Currency') }}</td>
                                                <td class="text-start">{{ optional($gateway->currency)->code }}</td>
                                            </tr>
                                            <tr>
                                                <td class="payment-td">{{ __('Gateway Charge') }}</td>
                                                <td class="text-start">{{ currency_format($gateway->charge, currency: $gateway->currency) }}</td>
                                            </tr>
                                            <tr>
                                                <td class="payment-td">{{ __('Payable Amount') }}</th>
                                                <td class="text-start">{{ currency_format($amount + $gateway->charge, currency: $gateway->currency) }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
