...
Route::group(['as' => 'admin.', 'prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    // Faq
    Route::resource('faqs', ADMIN\AcnooFaqController::class)->except('edit', 'create', 'show');
    ...
    // Tutorial
    Route::resource('tutorials', ADMIN\AcnooTutorialController::class)->except('edit', 'create', 'show');
    Route::post('tutorials/filter', [ADMIN\AcnooTutorialController::class, 'acnooFilter'])->name('tutorials.filter');
    Route::post('tutorials/delete-all', [ADMIN\AcnooTutorialController::class,'deleteAll'])->name('tutorials.delete-all');
    Route::post('tutorials/status/{id}',[ADMIN\AcnooTutorialController::class,'status'])->name('tutorials.status');
