    ...
    <div class="container">
        <div data-aos="fade-up" class="section-title text-center feature-header">
            <p class="langing-section-subtitle ">
                <span>{{ Str::words($page_data['headings']['feature_short_title'] ?? '', 5, '...') }}</span>
            </p>
            <h2 class="langing-section-title ">{{ Str::words($page_data['headings']['feature_title'] ?? '', 15, '...') }}
            </h2>
        </div>
        <div class="row">
