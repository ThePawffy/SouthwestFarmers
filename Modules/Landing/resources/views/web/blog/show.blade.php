    ...
    <section class="banner-bg p-4">
        <div class="container">
            <p class="mb-0 fw-medium custom-clr-dark">
                Home <span class="font-monospace">></span>Blog List<span class="font-monospace">></span>
                Blog Details
            </p>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-xl-8">
                    <div class="border rounded-16 blog-details-content mb-3">
                        <img src="{{ asset($blog->image) }}" alt="" class="w-100 rounded-top-16" />
                                ...
                                @foreach ($comments as $comment)
                                    <div class="d-flex align-items-start justify-content-between mt-3">
                                        <div class="d-flex align-items-start">
                                            <img src="{{ asset('assets/images/profile/avatar.svg') }}"
                ...
                <div class="col-xl-4">
                    ...
                    {{-- <h6>Tags</h6>
                    <div class="tags-btns">
                        <button class="btn btn-secondary mb-1 tags-btn blogs-tag-btn-selected">
                            Ip-camera
                        </button>
                        <button class="btn btn-secondary mb-1 tags-btn">
                            security-camera
                        </button>
                        <button class="btn btn-secondary mb-1 tags-btn">Business</button>
                        <button class="btn btn-secondary mb-1 tags-btn">
                            IP-ecurity-Camera
                        </button>
                        <button class="btn btn-secondary mb-1 tags-btn">Camera</button>
                        <button class="btn btn-secondary mb-1 tags-btn">Security</button>
                        <button class="btn btn-secondary mb-1 tags-btn">
                            manufacturing
                        </button>
                        <button class="btn btn-secondary mb-1 tags-btn">industry</button>
                    </div> --}}
                </div>
            </div>
        </div>
