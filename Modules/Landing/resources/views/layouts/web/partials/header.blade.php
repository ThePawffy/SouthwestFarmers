    ...
    <nav class="navbar navbar-expand-lg p-0">
        <div class="container">
            <a href="{{ route('home') }}" class="header-logo"><img class="img-fluid nav-logo"
                    src="{{ asset($general->value['admin_logo'] ?? 'assets/images/icons/upload-icon.svg') }}"
                    alt="header-logo" /></a>
            ...
            <div class="offcanvas offcanvas-start mobile-menu" data-bs-backdrop="static" tabindex="-1"
                ...
                <div class="offcanvas-body">
                    <div class="accordion accordion-flush" id="sidebarMenuAccordion">
                        ...
                        <div class="accordion-item">
                            <a href="{{ route('blogs.index') }}" class="accordion-button without-sub-menu" type="button">{{ __('Blogs') }}</a>
                        </div>
            ...
            <div class="collapse navbar-collapse">
                ...
                @php
                    ...
                    $headerBtnLink = $headings['header_btn_link'] ?? null;
                    $headerBtnText = $headings['header_btn_text'] ?? null;
                @endphp
