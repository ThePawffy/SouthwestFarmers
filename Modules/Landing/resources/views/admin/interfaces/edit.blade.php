            ...
            <div class="card shadow-sm">
                <div class="card-bodys">
                    ...
                    <div class="order-form-section p-16">
                        <form action="{{ route('admin.interfaces.update', $interface->id) }}" method="post"
                                    ...
                                    <div class="col-lg-6 mt-2">
                                        ...
                                        <div class="gpt-up-down-arrow position-relative">
                                            <select name="status" required="" class="form-control select-dropdown">
                                                <option @selected($interface->status == 1) value="1">{{ __('Active') }}
                                                </option>
                                                <option @selected($interface->status == 0) value="0">{{ __('Deactive') }}
                                                </option>
                                            </select>
                                            <span></span>
                                        </div>
                                    ...
                                    <div class="col-lg-6 mt-2">
                                        <div class="row">
                                            <div class="col-10">
                                                ...
                                                <input type="file" name="image" class="form-control file-input-change"
                                                    data-id="image">
                                            </div>
                                            <div class="col-2 align-self-center mt-4">
                                                <img class="table-img"
                                                    src="{{ asset($interface->image ?? 'assets/images/icons/upload.png') }}"
                                                    id="image" alt="img">
                                            </div>
                                        </div>
                                    </div>
