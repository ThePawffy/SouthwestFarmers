                ...
                <div class="card-bodys">
                    ...
                    <div class="order-form-section p-16">
                        <form action="{{ route('admin.testimonials.update', ['testimonial' => $testimonial]) }}"
                            method="post" enctype="multipart/form-data" class="ajaxform_instant_reload">
                            @csrf
                            @method('put')
                                    ...
                                    <div class="col-lg-6 mt-2">
                                        ...
                                        <div class="gpt-up-down-arrow position-relative">
                                            <select name="star" required="" class="form-control select-dropdown">
                                                <option @selected($testimonial->star == 1) value="1">{{ __('1') }}
                                                </option>
                                                <option @selected($testimonial->star == 2) value="2">{{ __('2') }}
                                                </option>
                                                <option @selected($testimonial->star == 3) value="3">{{ __('3') }}
                                                </option>
                                                <option @selected($testimonial->star == 4) value="4">{{ __('4') }}
                                                </option>
                                                <option @selected($testimonial->star == 5) value="5">{{ __('5') }}
                                                </option>
                                            </select>
                                            <span></span>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-2 align-self-center mt-4">
                                                <img class="img-fluid table-img"
                                                    src="{{ asset($testimonial->client_image ?? 'assets/images/icons/upload.png') }}"
                                                    id="image" alt="Img">
                                            </div>
                                        </div>
                                    </div>
