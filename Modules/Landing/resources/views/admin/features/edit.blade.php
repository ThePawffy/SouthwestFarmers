                            ...
                            <div class="add-suplier-modal-wrapper">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mt-2">
                                        ...
                                        <input type="color" name="bg_color" value="{{ $feature->bg_color }}" required
                                    ...
                                    <div class="col-sm-6 mt-2">
                                        ...
                                        <div class="gpt-up-down-arrow position-relative">
                                            <select name="status" required="" class="form-control select-dropdown">
                                                <option @selected($feature->status == 1) value="1">{{ __('Active') }}
                                                </option>
                                                <option @selected($feature->status == 0) value="0">{{ __('Deactive') }}
                                                </option>
                                            </select>
                                            <span></span>
                                        </div>
                                    ...
                                    <div class="col-lg-6 mt-2">
                                        <div class="row">
                                            ...
                                            <div class="col-2 align-self-center mt-4">
                                                <img class="table-img"
                                                    src="{{ asset($feature->image ?? 'assets/images/icons/upload.png') }}"
                                                    id="image" alt="img">
                                            </div>
                                        </div>
                                    </div>
