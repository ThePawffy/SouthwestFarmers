                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <ul class="nav nav-pills flex-column w-280">
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="#content" class="add-report-btn nav-link"
                                                            data-bs-toggle="tab">{{ __('Content Section') }}</a>
                                                    </li>
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="#printer" class="add-report-btn nav-link"
                                                            data-bs-toggle="tab">{{ __('Printer Section') }}</a>
                                                    </li>
                                                ...
                                                <form action="{{ route('admin.website-settings.update', 'manage-pages') }}"
                                                    ...
                                                    <div class="tab-content no-padding">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-12">
                                                                    ...
                                                                    <input type="text" name="slider_scanner_text"
                                                                        value="{{ $page_data['headings']['slider_scanner_text'] ?? '' }}" placeholder=" {{__('Enter Title')}} "
                                                                        required class="form-control">
                                                                </div>
                                                                ...
                                                                <div class="col-sm-10 align-self-center">
                                                                    <label>{{ __('Apple App Image') }}</label>
                                                                    <input type="file" name="apple_app_image" accept="image/*" class="form-control file-input-change" data-id="apple_app_image">
                                                                </div>

                                                                <div class="col-sm-2 align-self-center mt-3">
                                                                    <img class="table-img" id="apple_app_image"
                                                                        src="{{ asset($page_data['apple_app_image'] ?? 'assets/images/icons/img-upload.png') }}"
                                                                        alt="img">
                                                                </div>

                                                                <div class="col-sm-10 align-self-center">
                                                                    <label>{{ __('Google Play Image') }}</label>
                                                                    <input type="file" name="google_play_image" accept="image/*" class="form-control file-input-change" data-id="google_play_image">
                                                                </div>

                                                                <div class="col-sm-2 align-self-center mt-3">
                                                                    <img class="table-img" id="google_play_image"
                                                                        src="{{ asset($page_data['google_play_image'] ?? 'assets/images/icons/img-upload.png') }}"
                                                                        alt="img">
                                                                </div>
                                                        ...
                                                        <div class="tab-pane fade" id="header">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="header_btn_text"
                                                                    value="{{ $page_data['headings']['header_btn_text'] ?? '' }}" placeholder=" {{__('Enter Header Title')}} "
                                                                    required class="form-control">
                                                            </div>
                                                        ...
                                                        <div class="tab-pane fade" id="content">
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <h4 class="mb-3">{{ __('Content Type') }}</h4>

                                                                        @foreach ($page_data['headings']['content_type_short_texts'] ?? [] as $key => $content_type_short_texts)
                                                                            <div class="sample-form-wrp duplicate-feature pe-3">
                                                                                <div class="row mb-4">
                                                                                    <div class="col-sm-6">
                                                                                        <label>{{ __('Short Text') }}</label>
                                                                                        <input type="text" name="content_type_short_texts[]" value="{{ $content_type_short_texts ?? '' }}" required  placeholder="{{ __('Enter Short Title') }}" class="form-control">
                                                                                    </div>

                                                                                    <div class="col-sm-6">
                                                                                        <label>{{ __('Title') }}</label>
                                                                                        <input type="text" name="content_type_titles[]" value="{{ $page_data['headings']['content_type_titles'][$key] ?? '' }}" required placeholder="{{ __('Enter Title') }}" class="form-control">
                                                                                    </div>

                                                                                    <div class="col-sm-5 align-self-center">
                                                                                        <label>{{ __('Icon') }}</label>
                                                                                        <input type="file" name="content_type_icons[]" accept="image/*" class="form-control" onchange="readURL(this)">
                                                                                    </div>

                                                                                    <div class="col-sm-1 align-self-center mt-2">
                                                                                        <img  width="100%" height="auto" class="multi-image-preview" data-default-src="{{ asset('assets/img/demo-img.png') }}" id="footer_socials_icons" src="{{ asset($page_data['content_type_icons'][$key] ?? 'assets/img/demo-img.png') }}" alt="img">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        @endforeach
                                                        ...
                                                        <div class="tab-pane fade" id="feature">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="feature_short_title"
                                                                    value="{{ $page_data['headings']['feature_short_title'] ?? '' }}" placeholder=" {{__('Enter short Title')}} "
                                                                    required class="form-control">
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="feature_title"
                                                                    value="{{ $page_data['headings']['feature_title'] ?? '' }}" placeholder=" {{__('Enter Title')}} "
                                                                    required class="form-control">
                                                            </div>
                                                        </div>
                                                        {{-- Feature section End --}}
                                                        ...
                                                        <div class="tab-pane fade" id="interface">
                                                            <div class="form-group">
                                                                <label>{{ __('Short text') }}</label>
                                                                <input type="text" name="interface_short_text"
                                                                    value="{{ $page_data['headings']['interface_short_text'] ?? '' }}"
                                                        ...
                                                        <div class="tab-pane fade" id="pricing">
                                                            ...
                                                            <div class="form-group">
                                                                <label>{{ __('Short Title') }}</label>
                                                                <input type="text" name="pricing_short_title"
                                                                    value="{{ $page_data['headings']['pricing_short_title'] ?? '' }}" placeholder=" {{__('Enter Title')}} "
                                                                    required class="form-control">
                                                            </div>
                                                        ...
                                                        <div class="tab-pane fade" id="watch">
                                                            ...
                                                            <div class="form-group">
                                                                <label>{{ __('Title') }}</label>
                                                                <input type="text" name="watch_long_title"
                                                                    value="{{ $page_data['headings']['watch_long_title'] ?? '' }}"
                                                                    required class="form-control" placeholder=" {{__('Enter Title')}} ">
                                                            </div>
                                                        ...
                                                        <div class="tab-pane fade" id="payment">
                                                            <div class="form-group">
                                                                <label>{{ __('Short Title') }}</label>
                                                                <input type="text" name="payment_short_title"
                                                                    value="{{ $page_data['headings']['payment_short_title'] ?? '' }}"
                                                                    required class="form-control" placeholder=" {{__('Enter Title')}} ">
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="payment_title"
                                                                    value="{{ $page_data['headings']['payment_title'] ?? '' }}"
                                                                    required class="form-control" placeholder=" {{__('Enter Title')}} ">
                                                            </div>
                                                        ...
                                                        <div class="tab-pane fade" id="printer">
                                                            <div class="form-group">
                                                                <label>{{ __('Title') }}</label>
                                                                <input type="text" name="printer_title"
                                                                    value="{{ $page_data['headings']['printer_title'] ?? '' }}" placeholder=" {{__('Enter Title')}} "
                                                                    required class="form-control">
                                                            </div>

                                                            <div class="form-group">
                                                                <label>{{ __('Description') }}</label>
                                                                <textarea name="printer_desc" id="" cols="" rows="" class="form-control" placeholder=" {{__('Enter Description')}} ">{{ $page_data['headings']['printer_desc'] ?? '' }}</textarea>
                                                            </div>

                                                            <div class="row">
                                                                <div class="col-sm-10 align-self-center">
                                                                    <label>{{ __('Printer Image') }}</label>
                                                                    <input type="file" name="printer_image" accept="image/*" class="form-control file-input-change" data-id="printer_image">
                                                                </div>

                                                                <div class="col-sm-2 align-self-center mt-3">
                                                                    <img class="table-img" id="printer_image"
                                                                        src="{{ asset($page_data['printer_image'] ?? 'assets/images/icons/img-upload.png') }}"
                                                                        alt="img">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="tab-pane fade" id="blog">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="blog_title"
                                                                    value="{{ $page_data['headings']['blog_title'] ?? '' }}" placeholder=" {{__('Enter Title')}} "
                                                                    required class="form-control">
                                                            </div>
                                                            <div class="form-group">
                                                        ...
                                                        <div class="tab-pane fade" id="testimonial">
                                                            <div class="form-group">
                                                                <label>{{ __('Short Title') }}</label>
                                                                <input type="text" name="testimonial_short_title"
                                                                    value="{{ $page_data['headings']['testimonial_short_title'] ?? '' }}" placeholder=" {{__('Enter Title')}} "
                                                                    required class="form-control">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>{{ __('Testimonial Title') }}</label>
                                                                <input type="text" name="testimonial_title"
                                                                    value="{{ $page_data['headings']['testimonial_title'] ?? '' }}" placeholder=" {{__('Enter Title')}} "
                                                                    required class="form-control">
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-12">
                                                                    ...
                                                                    <input type="text" name="footer_scanner_title"
                                                                        value="{{ $page_data['headings']['footer_scanner_title'] ?? '' }}" placeholder=" {{__('Enter Title')}} "
                                                                        required class="form-control">
                                                                </div>
                                                                ...
                                                                <div class="col-lg-10 align-self-center">
                                                                    <label>{{ __('Scanner Image') }}</label>
                                                                    <input type="file" name="footer_scanner_image" accept="image/*" class="form-control file-input-change" data-id="footer_scanner_image">
                                                                </div>

                                                                <div class="col-lg-2 align-self-center mt-3">
                                                                    <img class="table-img"
                                                                        id="footer_scanner_image"
                                                                        src="{{ asset($page_data['footer_scanner_image'] ?? 'assets/images/icons/img-upload.png') }}"
                                                                        alt="img">
                                                                </div>
                                                                ...
                                                                <div class="col-5">
                                                                    ...
                                                                    <input type="text" name="footer_apple_app_link"
                                                                        value="{{ $page_data['headings']['footer_apple_app_link'] ?? '' }}" placeholder=" {{__('Enter Link')}} "
                                                                        class="form-control">
                                                                </div>
                                                                ...
                                                                <div class="col-lg-5 align-self-center">
                                                                    ...
                                                                    <input type="file" name="footer_apple_app_image" accept="image/*" class="form-control file-input-change" data-id="footer_apple_app_image">
                                                                </div>

                                                                <div class="col-lg-2 align-self-center mt-3">
                                                                    <img class="table-img"
                                                                        id="footer_apple_app_image"
                                                                        src="{{ asset($page_data['footer_apple_app_image'] ?? 'assets/images/icons/img-upload.png') }}"
                                                                        alt="img">
                                                                </div>
                                                                ...
                                                                <div class="col-5">
                                                                    ...
                                                                    <input type="text" name="footer_google_play_app_link"
                                                                        value="{{ $page_data['headings']['footer_google_play_app_link'] ?? '' }}" placeholder=" {{__('Enter Link')}} "
                                                                        class="form-control">
                                                                </div>
                                                                ...
                                                                <div class="col-lg-5 align-self-center">
                                                                    ...
                                                                    <input type="file" name="footer_google_app_image" accept="image/*" class="form-control file-input-change" data-id="footer_google_app_image">
                                                                </div>

                                                                <div class="col-lg-2 align-self-center mt-3">
                                                                    <img class="table-img"
                                                                        id="footer_google_app_image"
                                                                        src="{{ asset($page_data['footer_google_app_image'] ?? 'assets/images/icons/img-upload.png') }}"
                                                                        alt="img">
                                                                </div>
