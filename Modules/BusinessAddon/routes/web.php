...
use Modules\BusinessAddon\App\Http\Controllers as Business;
...
Route::group(['as' => 'business.', 'prefix' => 'business', 'middleware' => ['users', 'expired']], function () {
    ...
    Route::get('/earning', [Business\DashboardController::class, 'earningData'])->name('dashboard.earning');
    Route::get('/sales-purchases', [Business\DashboardController::class, 'salesPurchases'])->name('dashboard.sales.purchases');
    ...
    Route::get('sales/pdf/{sale_id}', [Business\AcnooSaleController::class, 'generatePDF'])->name('sales.pdf');
    ...
    Route::get('purchases/pdf/{purchase_id}', [Business\AcnooPurchaseController::class, 'generatePDF'])->name('purchases.pdf');
    ...
    Route::post('/customer-wise-prices', [Business\AcnooProductController::class, 'customerWisePrices'])->name('products.customer-prices');
    ...
    Route::get('/invoice', [Business\SettingController::class, 'invoiceIndex'])->name('invoice.index');
    Route::post('/invoice-settings', [Business\SettingController::class, 'updateInvoice'])->name('invoice.update');
    Route::get('/product-setting', [Business\SettingController::class, 'productIndex'])->name('product.setting.index');
    Route::post('/product-setting-update', [Business\SettingController::class, 'updateProductSetting'])->name('product.setting.update');
