...
use Modules\BusinessAddon\App\Exports\ExportExcelCsv;
use App\Models\Sale;
...
class AcnooSaleReportController extends Controller
{
    public function index()
    {
        ...
        return view('businessAddon::reports.sales.sale-reports', compact('sales','total_sale'));
    }
    ...
    public function acnooFilter(Request $request)
    {
        ...
        if ($request->ajax()) {
            return response()->json([
                'data' => view('businessAddon::reports.sales.datas', compact('sales'))->render(),
    ...
    public function generatePDF(Request $request)
    {
        ...
        $pdf = Pdf::loadview('businessAddon::reports.sales.pdf', compact('sales'));
