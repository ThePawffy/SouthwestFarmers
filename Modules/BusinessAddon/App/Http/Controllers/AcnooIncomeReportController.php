...
use Modules\BusinessAddon\App\Exports\ExportIncome;
...
class AcnooIncomeReportController extends Controller
{
    public function index()
    {
        ...
        return view('businessAddon::reports.income.income-reports', compact('income_reports', 'total_income'));
    }
    ...
    public function acnooFilter(Request $request)
    {
        ...
        if ($request->ajax()) {
            return response()->json([
                'data' => view('businessAddon::reports.income.datas', compact('income_reports'))->render(),
    ...
    public function generatePDF(Request $request)
    {
        ...
        $pdf = Pdf::loadview('businessAddon::reports.income.pdf', compact('income_reports'));
