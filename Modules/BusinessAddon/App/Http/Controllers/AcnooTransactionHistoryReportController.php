...
use Modules\BusinessAddon\App\Exports\ExportTransaction;
...
class AcnooTransactionHistoryReportController extends Controller
{
    public function index()
    {
        ...
        return view('businessAddon::reports.transaction-history.transaction-reports', compact('transactions', 'total_due', 'total_paid'));
    }

    public function acnooFilter(Request $request)
    {
        $businessId = auth()->user()->business_id;
        $transactionsQuery = DueCollect::with('party:id,name')->where('business_id', $businessId);
        ...
        if ($request->ajax()) {
            return response()->json([
                'data' => view('businessAddon::reports.transaction-history.datas', compact('transactions'))->render(),
    ...
    public function generatePDF(Request $request)
    {
        ...
        $pdf = Pdf::loadview('businessAddon::reports.transaction-history.pdf', compact('transcations'));
