...
use Modules\BusinessAddon\App\Exports\ExportSalesReturn;
...
class AcnooSaleReturnReportController extends Controller
{
    public function index()
    {
        ...
        return view('businessAddon::reports.sales-return.sale-reports', compact('sales','total_sale_return'));
    }
    ...
    public function acnooFilter(Request $request)
    {
        ...
        $salesQuery = Sale::with([
            ...
            ->whereHas('saleReturns', function ($query) use ($startDate, $endDate) {
        ...
        if ($request->ajax()) {
            return response()->json([
                'data' => view('businessAddon::reports.sales-return.datas', compact('sales'))->render(),
    ...
    public function generatePDF(Request $request)
    {
        $sales =  Sale::with([
            ...
            ->get();
        $pdf = Pdf::loadview('businessAddon::reports.sales-return.pdf', compact('sales'));
