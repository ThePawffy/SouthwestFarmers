...
use Modules\BusinessAddon\App\Exports\ExportExpense;
...
class AcnooExpenseReportController extends Controller
{
    public function index()
    {
        ...
        return view('businessAddon::reports.expense.expense-reports', compact('expense_reports', 'total_expense'));
    }
    ...
    public function acnooFilter(Request $request)
    {
        ...
        if ($request->filled('search')) {
            $expenseQuery->where(function ($query) use ($request) {
                $query->where('expenseFor', 'like', '%' . $request->search . '%')
        ...
        if ($request->ajax()) {
            return response()->json([
                'data' => view('businessAddon::reports.expense.datas', compact('expense_reports'))->render(),
    ...
    public function generatePDF(Request $request)
    {
        ...
        $pdf = Pdf::loadview('businessAddon::reports.expense.pdf', compact('expense_reports'));
