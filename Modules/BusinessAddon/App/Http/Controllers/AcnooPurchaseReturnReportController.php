...
use Modules\BusinessAddon\App\Exports\ExportPurchaseReturn;
...
class AcnooPurchaseReturnReportController extends Controller
{
    public function index()
    {
        ...
        return view('businessAddon::reports.purchase-return.purchase-reports', compact('purchases', 'total_purchase_return'));
    }
    ...
    public function acnooFilter(Request $request)
    {
        ...
        if ($request->ajax()) {
            return response()->json([
                'data' => view('businessAddon::reports.purchase-return.datas', compact('purchases'))->render(),
    ...
    public function generatePDF(Request $request)
    {
        $purchases = Purchase::with([
            ...
            ->get();
        $pdf = Pdf::loadview('businessAddon::reports.purchase-return.pdf', compact('purchases'));
