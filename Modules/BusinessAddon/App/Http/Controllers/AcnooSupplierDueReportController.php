...
use Modules\BusinessAddon\App\Exports\ExportSupplierDue;
...
class AcnooSupplierDueReportController extends Controller
{
    public function index()
    {
        ...
        return view('businessAddon::reports.supplier-due.due-reports', compact('due_lists','total_due'));
    }
    ...
    public function acnooFilter(Request $request)
    {
        ...
        if ($request->ajax()) {
            return response()->json([
                'data' => view('businessAddon::reports.supplier-due.datas', compact('due_lists'))->render()
            ]);
        }
    ...
    public function generatePDF(Request $request)
    {
        ...
        $pdf = Pdf::loadview('businessAddon::reports.supplier-due.pdf', compact('due_lists'));
