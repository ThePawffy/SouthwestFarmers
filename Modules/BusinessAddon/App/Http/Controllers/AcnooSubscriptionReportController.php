...
use Modules\BusinessAddon\App\Exports\ExportSubscription;
...
class AcnooSubscriptionReportController extends Controller
{
    public function index()
    {
        ...
        return view('businessAddon::reports.subscription-reports.subscription-reports', compact('subscribers'));
    }
    ...
    public function acnooFilter(Request $request)
    {
        ...
        if ($request->ajax()) {
            return response()->json([
                'data' => view('businessAddon::reports.subscription-reports.datas', compact('subscribers'))->render()
            ]);
        }
    ...
    public function generatePDF(Request $request)
    {
        ...
        $pdf = Pdf::loadview('businessAddon::reports.subscription-reports.pdf', compact('subscribers'));
    ...
    public function getInvoice(string $invoice_id)
    {
        ...
        return view('businessAddon::reports.subscription-reports.invoice', compact('subscriber'));
    }
}
