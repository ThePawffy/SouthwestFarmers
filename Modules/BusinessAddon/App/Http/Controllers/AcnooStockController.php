...
use Modules\BusinessAddon\App\Exports\ExportCurrentStock;
...
class AcnooStockController extends Controller
{
    public function index()
    {
        ...
        return view('businessAddon::stocks.index', [
            'products' => $paginated,
       ...
       $businessId = auth()->user()->business_id;
        ...
        if ($request->ajax()) {
            return response()->json([
                'data' => view('businessAddon::stocks.datas', [
                    'products' => $paginated,
                    'total_stock_value' => $total_stock_value,
                    'total_qty' => $total_qty
                ])->render()
    ...
    public function generatePDF(Request $request)
    {
        ...
        $pdf = Pdf::loadview('businessAddon::stocks.pdf', compact('stocks'));
