...
class UserRoleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('businessAddon::roles.index', compact('users'));
    }

    public function create()
    {
        return view('businessAddon::roles.create');
    }
        ...
        $request->validate([
         ...
         User::create([
            ...
            'visibility' => [
                ...
                'addVatPermission' => $request->addVatPermission == 'on' ? true : false,
                'addSubscriptionPermission' => $request->addSubscriptionPermission == 'on' ? true : false,
                'addDownloadapkPermission' => $request->addDownloadapkPermission == 'on' ? true : false,
                'addUpgradePlanPermission' => $request->addUpgradePlanPermission == 'on' ? true : false,
            ]
        ]);
    ...
    public function edit(string $id)
    {
        ...
        return view('businessAddon::roles.edit', compact('user'));
    }
