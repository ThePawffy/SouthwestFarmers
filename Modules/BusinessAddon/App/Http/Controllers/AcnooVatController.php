...
class AcnooVatController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('businessAddon::vats.index', compact('vats', 'vat_groups'));
    }
    ...
    public function acnooFilter(Request $request)
    {
        ...
        if ($request->ajax()) {
            return response()->json([
                'data' => view('businessAddon::vats.datas', compact('vats'))->render()
            ]);
        }
    ...
    public function VatGroupFilter(Request $request)
    {
        ...
        if ($request->ajax()) {
            return response()->json([
                'data' => view('businessAddon::vat-groups.datas', compact('vat_groups'))->render()
            ]);
        }
        return redirect(url()->previous());
    ...
    public function create()
    {
        ...
        return view('businessAddon::vat-groups.create',compact('vats'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('businessAddon::vat-groups.edit',compact('vat', 'vats'));
    }
