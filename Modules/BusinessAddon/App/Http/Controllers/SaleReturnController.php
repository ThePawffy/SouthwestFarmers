...
class SaleReturnController extends Controller
{
    ...
    {
        $sales = Sale::with(['user:id,name', 'party:id,name', 'details', 'details.product:id,productName,category_id', 'details.product.category:id,categoryName', 'saleReturns' => function ($query) {
        ...
        return view('businessAddon::sale-returns.index', compact('sales'));
    }
    ...
    public function acnooFilter(Request $request)
    {
        ...
        if($request->ajax()){
            return response()->json([
                'data' => view('businessAddon::sale-returns.datas',compact('sales'))->render()
            ]);
        }
    ...
    public function create(Request $request)
    {
        ...
        return view('businessAddon::sale-returns.create', compact('sale', 'discount_per_unit_factor', 'avg_rounding_amount'));
    }
