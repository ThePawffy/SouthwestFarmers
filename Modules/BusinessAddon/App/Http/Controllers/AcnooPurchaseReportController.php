...
use Modules\BusinessAddon\App\Exports\PurchaseExport;
...
class AcnooPurchaseReportController extends Controller
{
    public function index()
    {
        ...
        return view('businessAddon::reports.purchase.purchase-reports', compact('purchases', 'total_purchase'));
    }
    ...
    public function acnooFilter(Request $request)
    {
        ...
        if ($request->ajax()) {
            return response()->json([
                'data' => view('businessAddon::reports.purchase.datas', compact('purchases'))->render(),
    ...
    public function generatePDF(Request $request)
    {
        ...
        $pdf = Pdf::loadview('businessAddon::reports.purchase.pdf', compact('purchases'));
