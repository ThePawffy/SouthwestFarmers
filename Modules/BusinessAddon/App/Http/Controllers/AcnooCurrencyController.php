...
class AcnooCurrencyController extends Controller
{
    public function index()
    {
        ...
        return view('businessAddon::currencies.index', compact('currencies','user_currency'));
    }
    ...
    public function acnooFilter(Request $request)
    {
        ...
        if ($request->ajax()) {
            return response()->json([
                'data' => view('businessAddon::currencies.datas', compact('currencies', 'user_currency'))->render()
            ]);
        }
