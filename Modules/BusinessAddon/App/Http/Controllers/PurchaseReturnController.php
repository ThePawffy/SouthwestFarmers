...
class PurchaseReturnController extends Controller
{
    ...
    {
        $purchases = Purchase::with(['user:id,name', 'party:id,name,email,phone,type', 'details:id,purchase_id,product_id,productPurchasePrice,quantities', 'details.product:id,productName,category_id', 'details.product.category:id,categoryName',
        ...
        return view('businessAddon::purchase-returns.index',compact('purchases'));
    }
    ...
    public function acnooFilter(Request $request)
    {
        ...
        if($request->ajax()){
            return response()->json([
                'data' => view('businessAddon::purchase-returns.datas',compact('purchases'))->render()
            ]);
        }
    ...
    public function create(Request $request)
    {
        ...
        return view('businessAddon::purchase-returns.create', compact('purchase', 'discount_per_unit_factor'));
    }
