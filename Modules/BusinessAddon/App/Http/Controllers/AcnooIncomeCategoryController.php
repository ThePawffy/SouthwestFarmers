...
class AcnooIncomeCategoryController extends Controller
{
    public function index()
    {
        ...
        return view('businessAddon::income-categories.index', compact('income_categories'));
    }
    ...
    public function acnooFilter(Request $request)
    {
        ...
        if($request->ajax()){
            return response()->json([
                'data' => view('businessAddon::income-categories.datas',compact('income_categories'))->render()
            ]);
        }
