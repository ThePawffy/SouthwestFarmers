...
class AcnooPartyController extends Controller
{
   use HasUploader;
    ...
    public function index()
    {
        ...
        return view('businessAddon::parties.index', compact('parties', 'party_type'));
    }
    ...
    public function acnooFilter(Request $request)
    {
        ...
        if ($request->ajax()) {
            return response()->json([
                'data' => view('businessAddon::parties.datas', compact('parties'))->render()
            ]);
        }
    ...
    {
        return view('businessAddon::parties.create');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('businessAddon::parties.edit', compact('party'));
    }
