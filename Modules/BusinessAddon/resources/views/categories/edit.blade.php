                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 mb-2">
                                ...
                                <div class="border rounded upload-img-container">
                                    ...
                                    <div class="img-wrp">
                                        <img src="{{ asset('assets/images/icons/upload-icon.svg') }}" id="category_icon" src="#" alt="Preview Image">
                                    </div>
                                    <input
                                        type="file"
                                        name="icon"
                            ...
                            <div class="mt-3">
                                ...
                                <div class="select-variations-container d-flex align-items-center gap-2 mt-2">
                                    <div class="select-variations-content d-flex align-items-center gap-2">
                                        <input class="category-check variations-input" type="checkbox" name="variationCapacity" value="true" id="capacityCheck">
                                        <label class="form-check-label variations-label" for="capacityCheck">
                                            {{ __('Capacity') }}
                                        </label>
                                    </div>
                                    <div class="select-variations-content d-flex align-items-center gap-2">
                                        <input class="category-check variations-input" type="checkbox" name="variationColor" value="true" id="colorCheck">
                                        <label class="form-check-label variations-label" for="colorCheck">
                                            {{ __('Color') }}
                                        </label>
                                    </div>
                                    <div class="select-variations-content d-flex align-items-center gap-2">
                                        <input class="category-check variations-input" type="checkbox" name="variationSize" value="true" id="sizeCheck">
                                        <label class="form-check-label variations-label" for="sizeCheck">
                                            {{ __('Size') }}
                                        </label>
                                    </div>
                                    <div class="select-variations-content d-flex align-items-center gap-2">
                                        <input class="category-check variations-input" type="checkbox"
