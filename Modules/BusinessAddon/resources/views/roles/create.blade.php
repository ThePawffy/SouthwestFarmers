                                ...
                                <div class="">
                                    <div class="row">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="text-start border-0">
                                                        <div class="custom-control custom-checkbox d-flex justify-content-end border-bottom pb-2 align-items-center gap-2">
                                                ...
                                                <tr>
                                                    <td class="border-0">
                                                        <div class="row g-2">
                                                            <div class="d-flex col-lg-4 col-md-6 mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5 d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="profileEditPermission"
                                                                        class="delete-checkbox-item  multi-delete" id="profile_edit">
                                                                    <label class="custom-control-label fw-bold"
                                                            ...
                                                            <div class="d-flex col-lg-4 col-md-6 mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5 d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="salePermission"
                                                                        class="delete-checkbox-item  multi-delete" id="sale">
                                                                    <label class="custom-control-label fw-bold"
                                                            ...
                                                            <div class="d-flex col-lg-4 col-md-6 mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5 d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="salesListPermission"
                                                                           class="delete-checkbox-item  multi-delete" id="sale_list">
                                                                    <label class="custom-control-label fw-bold"
                                                                           for="sale_list">{{ __('Sales List') }}</label>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex col-lg-4 col-md-6 mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5 d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="purchasePermission" class="delete-checkbox-item  multi-delete" id="purchase">
                                                            ...
                                                            <div class="d-flex col-lg-4 col-md-6 mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5 d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="purchaseListPermission"
                                                                           class="delete-checkbox-item  multi-delete" id="purchase_list">
                                                                    <label class="custom-control-label fw-bold"
                                                                           for="purchase_list">{{ __('Purchase List') }}</label>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex col-lg-4 col-md-6 mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5 d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="productPermission" class="delete-checkbox-item  multi-delete" id="product">
                                                            ...
                                                            <div class="d-flex col-lg-4 col-md-6 mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5 d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="stockPermission"
                                                                           class="delete-checkbox-item  multi-delete" id="stock">
                                                                    <label class="custom-control-label fw-bold"
                                                            ...
                                                            <div class="d-flex col-lg-4 col-md-6 mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5 d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="partiesPermission"
                                                                           class="delete-checkbox-item  multi-delete" id="party">
                                                                    <label class="custom-control-label fw-bold"
                                                            ...
                                                            <div class="d-flex col-lg-4 col-md-6 mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5 d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="addIncomePermission"
                                                                           class="delete-checkbox-item  multi-delete" id="income">
                                                                    <label class="custom-control-label fw-bold"
                                                                           for="income">{{ __('Income') }}</label>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex col-lg-4 col-md-6 mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5 d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="addExpensePermission"
                                                                           class="delete-checkbox-item  multi-delete" id="expense">
                                                                    <label class="custom-control-label fw-bold"
                                                                           for="expense">{{ __('Expense') }}</label>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex col-lg-4 col-md-6 mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5 d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="dueListPermission" class="delete-checkbox-item  multi-delete" id="due_list">
                                                            ...
                                                            <div class="d-flex col-lg-4 col-md-6 mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5 d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="lossProfitPermission"
                                                                           class="delete-checkbox-item  multi-delete" id="loss_profit">
                                                                    <label class="custom-control-label fw-bold"
                                                                           for="loss_profit">{{ __('Loss Profit') }}</label>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex col-lg-4 col-md-6 mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5 d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="reportsPermission"
                                                                        class="delete-checkbox-item  multi-delete" id="reports">
                                                                    <label class="custom-control-label fw-bold"
                                                                        for="reports">{{ __('Reports') }}</label>
                                                                </div>
                                                            </div>

                                                            <div class="d-flex col-lg-4 col-md-6 mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5 d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="addVatPermission" class="delete-checkbox-item  multi-delete" id="vat">
                                                                    <label class="custom-control-label fw-bold" for="vat">{{ __('Vat') }}</label>
                                                                </div>
                                                            </div>

                                                            <div class="d-flex col-lg-4 col-md-6 mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5 d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="addSubscriptionPermission" class="delete-checkbox-item  multi-delete" id="subscription">
                                                                    <label class="custom-control-label fw-bold" for="subscription">{{ __('Subacription') }}</label>
                                                                </div>
                                                            </div>

                                                            <div class="d-flex col-lg-4 col-md-6 mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5 d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="addDownloadapkPermission" class="delete-checkbox-item  multi-delete" id="download_apk">
                                                                    <label class="custom-control-label fw-bold" for="download_apk">{{ __('Download Apk') }}</label>
                                                                </div>
                                                            </div>

                                                            <div class="d-flex col-lg-4 col-md-6 mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5 d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="addUpgradePlanPermission" class="delete-checkbox-item  multi-delete" id="plan">
                                                                    <label class="custom-control-label fw-bold" for="plan">{{ __('Upgrade Plan') }}</label>
                                                                </div>
                                                            </div>
                                        ...
                                        <div
                                            ...
                                            <button type="reset" class="btn btn-sm role-reset-btn"><i class="fas fa-undo-alt"></i> {{ __('Reset') }}</button>
