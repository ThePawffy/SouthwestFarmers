                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="row">
                                                            ...
                                                            <div class="d-flex col-lg-4 mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5  d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="salesListPermission"
                                                                           class="custom-control-input user-check-box" id="sale_list"
                                                            ...
                                                            <div class="d-flex col-lg-4 mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5  d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="purchaseListPermission"
                                                                           class="custom-control-input user-check-box" id="purchase_list"
                                                            ...
                                                            <div class="d-flex col-lg-4 mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5  d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="addIncomePermission"
                                                                           class="custom-control-input user-check-box" id="income"
                                                            ...
                                                            <div class="d-flex col-lg-4 mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5  d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="addExpensePermission"
                                                                           class="custom-control-input user-check-box" id="expense"
                                                            ...
                                                            <div class="d-flex col-lg-4 mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5  d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="lossProfitPermission"
                                                                           class="custom-control-input user-check-box" id="loss_profit"
                                                            ...
                                                            <div class="d-flex col-lg-4 mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5  d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="reportsPermission"
                                                                        class="custom-control-input user-check-box" id="report"
                                                                        {{ $user->visibility['reportsPermission'] ?? false ? 'checked' : '' }}>
                                                                    <label class="custom-control-label fw-bold"
                                                                        for="report">{{ __('Reports') }}</label>
                                                                </div>
                                                            </div>

                                                            <div class="d-flex col-lg-4 mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5 d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="addVatPermission" id="vat" class="custom-control-input user-check-box" {{ $user->visibility['addVatPermission'] ?? false ? 'checked' : '' }}>
                                                            ...
                                                            <div class="d-flex col-lg-4  mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5 d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="addSubscriptionPermission" id="subscription" class="custom-control-input user-check-box" {{ $user->visibility['addSubscriptionPermission'] ?? false ? 'checked' : '' }}>
                                                            ...
                                                            <div class="d-flex col-lg-4  mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5 d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="addDownloadapkPermission" id="download_apk" class="custom-control-input user-check-box" {{ $user->visibility['addDownloadapkPermission'] ?? false ? 'checked' : '' }}>
                                                            ...
                                                            <div class="d-flex col-lg-4  mb-2">
                                                                <div class="custom-control custom-checkbox mr-3 me-lg-5 d-flex align-items-center gap-2">
                                                                    <input type="checkbox" name="addUpgradePlanPermission" id="plan" class="custom-control-input user-check-box" {{ $user->visibility['addUpgradePlanPermission'] ?? false ? 'checked' : '' }}>
