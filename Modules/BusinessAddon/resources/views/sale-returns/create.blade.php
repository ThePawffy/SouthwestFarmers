                    ...
                    <div class="mt-4 mb-3 order-form-section ">
                        <div class="row g-3">
                            <div class="col-lg-4">
                                ...
                                <input type="text" value="{{ $sale->party->name ?? '' }}" class="form-control"  placeholder="{{ __('Name') }}." readonly>
                            </div>
                            <div class="col-lg-4">
                                <label>{{ __('Date') }}</label>
                    ...
                    <div class="cart-paymen mt-5">
                        ...
                        <div class="py-3 col-lg-12">
                            <h6 class="text-end fw-bold return_amount">
                                {{ __('Return Amount') . currency_format($sale->totalAmount, currency: business_currency()) }}
                            </h6>
                        </div>
                    </div>
