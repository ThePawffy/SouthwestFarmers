        ...
        <div class="in-content">
            <div class="d-flex justify-content-between align-items-center gap-3 print-logo-container">
                ...
                <div class="d-flex align-items-center gap-2 logo">
                    @php
                        $logoPath = public_path(get_business_option('business-settings')['invoice_logo'] ?? 'assets/images/icons/default.svg');
                    ...
                    <table class="table">
                        <tbody>
                            <tr class="in-table-row">
                                ...
                                <td class="text-end">: {{ $party->name ?? 'Cash' }}</td>
                            </tr>
                            <tr class="in-table-row">
                                <td class="text-end">{{ __('Mobile') }}</td>
                                <td class="text-end">: {{ $party->phone ?? '' }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
