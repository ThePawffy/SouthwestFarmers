                        ...
                        <div class="add-suplier-modal-wrapper d-block">
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-2">
                                    ...
                                    <input type="number" id="totalAmount" value="{{ number_format($party_opening_due, 2, '.', '') }}" readonly class="form-control">
                                </div>
                                ...
                                <div class="col-lg-6 mb-2">
                                    ...
                                    <input type="number" id="dueAmount" value="{{ number_format($party_opening_due, 2, '.', '') }}" readonly class="form-control">
                                </div>
