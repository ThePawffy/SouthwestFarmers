                    ...
                    <table class="table bg-striped" id="datatable">
                        <thead>
                            <tr>
                                ...
                                <th class="text-start striped-th">{{ __('Invoice') }}</th>
                                <th class="text-start striped-th">{{ __('Name') }}</th>
                                <th class="text-start striped-th">{{ __('Total') }}</th>
                                <th class="text-start striped-th">{{ __('Loss/Profit') }}</th>
                                <th class="text-start striped-th">{{ __('Date') }}</th>
                                <th class="text-center striped-th">{{ __('Status') }}</th>
                                <th class="d-print-none striped-th">{{ __('Action') }}</th>
                            </tr>
                        </thead>
                        <tbody id="loss-profit-data">
                            @include('businessAddon::loss-profits.datas')
                        </tbody>
                    </table>
                </div>
                <div class="mt-3">
...
@push('modal')
    @include('businessAddon::loss-profits.view')
@endpush
