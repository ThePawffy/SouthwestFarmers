            ...
            <div class="card ">
                ...
                <div class="responsive-table m-0">
                    <table class="table bg-striped" id="datatable">
                        <thead>
                            <tr>
                                <th class="w-60 d-print-none striped-th">
                                ...
                                <th class="striped-th"> {{ __('Product Name') }} </th>
                                <th class="striped-th"> {{ __('Code') }} </th>
                                <th class="striped-th"> {{ __('Brand') }} </th>
                                <th class="striped-th"> {{ __('Category') }} </th>
                                <th class="striped-th"> {{ __('Unit') }} </th>
                                <th class="striped-th"> {{ __('Purchase price') }}</th>
                                <th class="striped-th"> {{ __('Sale price') }}</th>
                                <th class="striped-th"> {{ __('Stock') }}</th>
                                <th class="striped-th print-d-none"> {{ __('Action') }} </th>
                            </tr>
                        </thead>
                        <tbody id="product-data">
                            @include('businessAddon::products.datas')
                        </tbody>
                    </table>
                </div>
                <div class="mt-3">
...
@push('modal')
    ...
    @include('businessAddon::products.view')
    @include('businessAddon::products.stock-modal')
@endpush
