                                                    ...
                                                    @if (is_module_enabled($modules, 'show_exclusive_price'))
                                                        <td>
                                                            <input type="number" step="any" min="0" class="form-control form-control-sm custom-table-input exclusive_price" name="stocks[{{ $index }}][exclusive_price]"
                                                                   value="{{ $stock->vat_type == 'exclusive' ? $stock->productPurchasePrice : $stock->productPurchasePrice - $stock->vat_amount }}"
                                                                   placeholder="Ex: 50">
                                                        </td>
                                                    @endif
                                                    @if (is_module_enabled($modules, 'show_inclusive_price'))
                                                        <td>
                                                            <input type="number" step="any" min="0" class="form-control form-control-sm custom-table-input inclusive_price" name="stocks[{{ $index }}][inclusive_price]"
                                                                   value="{{ $stock->vat_type == 'inclusive' ? $stock->productPurchasePrice : $stock->productPurchasePrice + $stock->vat_amount }}"
                                                                   placeholder="Ex: 50">
                                                        </td>
                                                    @endif
                                                    @if (is_module_enabled($modules, 'show_profit_percent'))
                                ...
                                <div class="row">
                                    ...
                                    @if (is_module_enabled($modules, 'show_product_stock'))
                                        <div class="col-lg-6 mb-2">
                                            ...
                                            <input type="number" name="stocks[0][productStock]" class="form-control" value="{{ $isSingle ? $singleStock->productStock : '' }}">
                                        </div>
                                    @endif
                                    ...
                                    @if (is_module_enabled($modules, 'show_exclusive_price'))
                                        <div class="col-lg-6 mb-2">
                                            ...
                                            <input type="number" class="form-control exclusive_price" name="stocks[0][exclusive_price]"
                                                   value="{{ $isSingle ? ($singleStock->vat_type == 'exclusive' ? $singleStock->productPurchasePrice : $singleStock->productPurchasePrice - $singleStock->vat_amount) : '' }}"
                                    ...
                                    @if (is_module_enabled($modules, 'show_inclusive_price'))
                                        <div class="col-lg-6 mb-2">
                                            ...
                                            <input type="number" class="form-control inclusive_price" name="stocks[0][inclusive_price]"
                                                   value="{{ $isSingle ? ($singleStock->vat_type == 'inclusive' ? $singleStock->productPurchasePrice : $singleStock->productPurchasePrice + $product->vat_amount) : '' }}"
                                                   placeholder="Enter Purchase Price" required>
                                        </div>
                                    @endif
                                    ...
                                    @if (is_module_enabled($modules, 'show_profit_percent'))
                                        <div class="col-lg-6 mb-2">
                                            <label>Profit (%)</label>
                                            <input type="number" class="form-control profit_percent" name="stocks[0][profit_percent]" value="{{ $isSingle ? $singleStock->profit_percent : '' }}">
                                        </div>
                                    @endif
                                    ...
                                    @if (is_module_enabled($modules, 'show_product_sale_price'))
                                        <div class="col-lg-6 mb-2">
                                            ...
                                            <input type="number" class="form-control productSalePrice" name="stocks[0][productSalePrice]" value="{{ $isSingle ? $singleStock->productSalePrice : '' }}">
                                        </div>
                                    @endif
                                    ...
                                    @if (is_module_enabled($modules, 'show_product_wholesale_price'))
                                        <div class="col-lg-6 mb-2">
                                            ...
                                            <input type="number" name="stocks[0][productWholeSalePrice]" class="form-control" value="{{ $isSingle ? $singleStock->productWholeSalePrice : '' }}">
                                        </div>
                                    @endif
                                    ...
                                    @if (is_module_enabled($modules, 'show_product_dealer_price'))
                                        <div class="col-lg-6 mb-2">
                                            ...
                                            <input type="number" name="stocks[0][productDealerPrice]" class="form-control" value="{{ $isSingle ? $singleStock->productDealerPrice : '' }}">
                                        </div>
                                    @endif
                                    ...
                                    @if (is_module_enabled($modules, 'show_mfg_date'))
                                        @if(empty($modules['mfg_date_type']) || $modules['mfg_date_type'] === 'dmy')
                                            <div class="col-lg-6 mb-2">
                                                ...
                                                <input type="date" name="stocks[0][mfg_date]" value="{{ $isSingle ? $singleStock->mfg_date : '' }}" class="form-control">
                                            </div>
                                        @else
                                            <div class="col-lg-6 mb-2">
                                                <label>{{ __('Manufacturing Date') }}</label>
                                                <input type="month" name="stocks[0][mfg_date]" value="{{ $isSingle ? $singleStock->mfg_date : '' }}" class="form-control">
                                            </div>
                                        @endif
                                    @endif
                                    ...
                                    @if (is_module_enabled($modules, 'show_expire_date'))
                                        @if(empty($modules['expire_date_type']) || $modules['expire_date_type'] === 'dmy')
                                            <div class="col-lg-6 mb-2">
                                                ...
                                                <input type="date" name="stocks[0][expire_date]" value="{{ $isSingle ? $singleStock->expire_date : '' }}" class="form-control">
                                            </div>
                                        @else
                                            <div class="col-lg-6 mb-2">
                                                <label>{{ __('Expire Date') }}</label>
                                                <input type="month" name="stocks[0][expire_date]" value="{{ $isSingle ? $singleStock->expire_date : '' }}" class="form-control">
                                            </div>
                                        @endif
                                    @endif
