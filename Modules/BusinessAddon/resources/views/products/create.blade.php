...
@section('main_content')
                                ...
                                <div class="table-header p-16">
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div class="position-relative">
                                            <a class="product-settings" href="{{ route('business.product.setting.index') }}">
                                            ...
                                            {{-- <div id="productSettingsPopup" class="settings-popup hidden">
                                                <div class="popup-header">
                                                    <span>Product Settings</span>
                                                    <button type="button" class="close-popup">
                                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15 5L5 15" stroke="#C52127" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M5 5L15 15" stroke="#C52127" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                                    </button>
                                                </div>
                                                <ul class="settings-list">
                                                    <li><input class="delete-checkbox-item  multi-delete" id="Brand" type="checkbox" checked> <label for="Brand">Brand</label></li>
                                                    <li><input class="delete-checkbox-item  multi-delete" id="Model" type="checkbox" checked> <label for="Model">Model</label></li>
                                                    <li><input class="delete-checkbox-item  multi-delete" id="SKU" type="checkbox" checked> <label for="SKU">SKU/Code</label></li>
                                                    <li><input class="delete-checkbox-item  multi-delete" id="Batch" type="checkbox" checked> <label for="Batch">Batch No</label></li>
                                                    <li><input class="delete-checkbox-item  multi-delete" id="Tax" type="checkbox" checked> <label for="Tax">Tax</label></li>
                                                    <li><input class="delete-checkbox-item  multi-delete" id="Date" type="checkbox" checked> <label for="Date">Date format</label></li>
                                                    <li><input class="delete-checkbox-item  multi-delete" id="Warranty" type="checkbox" checked> <label for="Warranty">Warranty</label></li>
                                                    <li><input class="delete-checkbox-item  multi-delete" id="Guarantee" type="checkbox" checked> <label for="Guarantee">Guarantee</label></li>
                                                    <li><input class="delete-checkbox-item  multi-delete" id="Sale" type="checkbox" checked> <label for="Sale"> Sale online</label></li>
                                                    <li><input class="delete-checkbox-item  multi-delete" id="Variations" type="checkbox" checked> <label for="Variations">Variations</label></li>
                                                </ul>
                                                <a href="#" class="">
                                                    <div class="save-publish-btn text-center more-setting-btn">
                                                        More Settings
                                                    </div>
                                                </a>
                                            </div> --}}
                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="gpt-up-down-arrow position-relative">
                                                        <select name="brand_id"
                                                            ...
                                                            @foreach ($brands as $brand)
                                                                <option
                                                                    value="{{ $brand->id }}"> {{ ucfirst($brand->brandName) }}</option>
                                                            @endforeach
                                                        </select>
                                                        <span></span>
                                                    </div>
                                                    ...
                                                    <div class="gpt-up-down-arrow position-relative">
                                                        <select name="model_id"
                                                            ...
                                                            @foreach ($product_models as $model)
                                                                <option
                                                                    value="{{ $model->id }}"> {{ ucfirst($model->name) }}</option>
                                                            @endforeach
                                                        </select>
                                                        <span></span>
                                                    </div>
                                                    ...
                                                    <div class="gpt-up-down-arrow position-relative">
                                                        <select name="unit_id"
                                                            ...
                                                            @foreach ($units as $unit)
                                                                <option
                                                                    value="{{ $unit->id }}"> {{ ucfirst($unit->unitName) }}</option>
                                                            @endforeach
                                                        </select>
                                                        <span></span>
                                                    </div>
                                            ...
                                            @if (is_module_enabled($modules, 'show_product_code'))
                                                <div class="col-lg-6 mb-2">
                                                    ...
                                                    <input type="text" value="{{ $code }}" name="productCode"
                                                           class="form-control"
                                            ...
                                            @if (is_module_enabled($modules, 'show_alert_qty'))
                                                <div class="col-lg-6 mb-2">
                                                    ...
                                                    <input type="number" step="any" name="alert_qty"
                                                           class="form-control" placeholder="{{ __('EX: 5') }}">
                                                </div>
                                            @endif
                            ...
                            <div class="product-price-header">
                                ...
                                <div class="d-flex align-items-center justify-content-center gap-3">
                                    @if ($showSingle && $showVariant)
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="product_type"
                                                   id="singleOption" value="single" checked>
                                            <label class="form-check-label" for="singleOption">Single</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="product_type"
                                                   id="variantOption" value="variant">
                                    ...
                                    @elseif ($showVariant)
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="product_type"
                                                   id="variantOption" value="variant" checked>
                                            <label class="form-check-label" for="variantOption">Batch</label>
                                        </div>
                                    @endif
                                </div>
                            ...
                            <div class="variant-container">
                                ...
                                <div class="responsive-table product-table m-0 mt-3">
                                    <table class="table" id="datatable">
                                        ...
                                        <tr>
                                            @if (is_module_enabled($modules, 'show_batch_no'))
                                                <td><input type="text" name="stocks[0][batch_no]"
                                                           class="form-control form-control-sm custom-table-input"
                                                           placeholder="25632"></td>
                                            @endif
                                            @if (is_module_enabled($modules, 'show_product_stock'))
                                                <td><input type="number" step="any" min="0"
                                                           name="stocks[0][productStock]"
                                                           class="form-control form-control-sm custom-table-input"
                                                           placeholder="3"></td>
                                            @endif
                                            ...
                                            @if (is_module_enabled($modules, 'show_exclusive_price'))
                                                <td>
                                                    <input type="number" step="any" min="0"
                                                           class="form-control form-control-sm custom-table-input exclusive_price"
                                                           name="stocks[0][exclusive_price]" placeholder="Ex: 50">
                                                </td>
                                            @endif
                                            ...
                                            @if (is_module_enabled($modules, 'show_inclusive_price'))
                                                <td>
                                                    <input type="number" step="any" min="0"
                                                           class="form-control form-control-sm custom-table-input inclusive_price"
                                                           name="stocks[0][inclusive_price]" placeholder="Ex: 50">
                                                </td>
                                            @endif
                                            ...
                                            @if (is_module_enabled($modules, 'show_profit_percent'))
                                                <td>
                                                    <input type="number"
                                                           class="form-control form-control-sm custom-table-input profit_percent"
                                                           name="stocks[0][profit_percent]" placeholder="25%">
                                                </td>
                                            @endif
                                            @if (is_module_enabled($modules, 'show_product_sale_price'))
                                                <td>
                                                    <input type="number" step="any" min="0" value="{{ $modules['default_sale_price'] ?? '' }}" class="form-control form-control-sm custom-table-input productSalePrice" name="stocks[0][productSalePrice]" placeholder="Ex: 200">
                                                </td>
                                            @endif
                                            @if (is_module_enabled($modules, 'show_product_wholesale_price'))
                                                <td><input type="number" step="any" min="0" name="stocks[0][productWholeSalePrice]" value="{{ $modules['default_wholesale_price'] ?? '' }}" class="form-control form-control-sm custom-table-input" placeholder="Ex: 200"></td>
                                            @endif
                                            @if (is_module_enabled($modules, 'show_product_dealer_price'))
                                                <td><input type="number" step="any" min="0" name="stocks[0][productDealerPrice]" class="form-control form-control-sm custom-table-input" value="{{ $modules['default_dealer_price'] ?? '' }}" placeholder="Ex: 200"></td>
                                            @endif

                                            @if (is_module_enabled($modules, 'show_mfg_date'))
                                                @if(empty($modules['mfg_date_type']) || $modules['mfg_date_type'] === 'dmy')
                                                    <td><input type="date" name="stocks[0][mfg_date]"
                                                               value="{{ $modules['default_mfg_date'] ?? '' }}"
                                                               class="form-control"></td>
                                                @else
                                                    <td><input type="month" name="stocks[0][mfg_date]"
                                                               value="{{ $modules['default_mfg_date'] ?? '' }}"
                                                               class="form-control"></td>
                                                @endif
                                            @endif
                                            ...
                                            @if (is_module_enabled($modules, 'show_expire_date'))
                                                @if(empty($modules['expire_date_type']) || $modules['expire_date_type'] === 'dmy')
                                                    <td><input type="date" name="stocks[0][expire_date]"
                                                               value="{{ $modules['default_expired_date'] ?? '' }}"
                                                               class="form-control"></td>
                                                @else
                                                    <td><input type="month" name="stocks[0][expire_date]"
                                                               value="{{ $modules['default_expired_date'] ?? '' }}"
                                                               class="form-control"></td>
                                                @endif
                                            @endif
                                ...
                                <div class="row">
                                    ...
                                    @if (is_module_enabled($modules, 'show_exclusive_price'))
                                        <div class="col-lg-6 mb-2">
                                            ...
                                            <input type="number" class="form-control exclusive_price"
                                                   name="stocks[0][exclusive_price]" placeholder="Enter Purchase Price">
                                        </div>
                                    @endif
                                    ...
                                    @if (is_module_enabled($modules, 'show_inclusive_price'))
                                        <div class="col-lg-6 mb-2">
                                            ...
                                            <input type="number" class="form-control inclusive_price"
                                                   name="stocks[0][inclusive_price]" placeholder="Enter Purchase Price">
                                        </div>
                                    @endif
                                    ...
                                    @if (is_module_enabled($modules, 'show_profit_percent'))
                                        <div class="col-lg-6 mb-2">
                                            ...
                                            <input type="number" class="form-control profit_percent"
                                                   name="stocks[0][profit_percent]" placeholder="Enter profit margin">
                                        </div>
                                    @endif
                                    ...
                                    @if (is_module_enabled($modules, 'show_product_sale_price'))
                                        <div class="col-lg-6 mb-2">
                                            ...
                                            <input type="number" class="form-control productSalePrice" value="{{ $modules['default_sale_price'] ?? '' }}"  name="stocks[0][productSalePrice]" placeholder="Ex: 10">
                                        </div>
                                    @endif
                                    ...
                                    @if (is_module_enabled($modules, 'show_product_wholesale_price'))
                                        <div class="col-lg-6 mb-2">
                                            ...
                                            <input type="number" name="stocks[0][productWholeSalePrice]" value="{{ $modules['default_wholesale_price'] ?? '' }}" class="form-control" placeholder="Ex: 10">
                                        </div>
                                    @endif
                                    ...
                                    @if (is_module_enabled($modules, 'show_product_dealer_price'))
                                        <div class="col-lg-6 mb-2">
                                            ...
                                            <input type="number" name="stocks[0][productDealerPrice]" value="{{ $modules['default_dealer_price'] ?? '' }}" class="form-control" placeholder="Ex: 10">
                                        </div>
                                    @endif
                                    ...
                                    @if (is_module_enabled($modules, 'show_mfg_date'))
                                        @if(empty($modules['mfg_date_type']) || $modules['mfg_date_type'] === 'dmy')
                                            <div class="col-lg-6 mb-2">
                                                ...
                                                <input type="date" name="stocks[0][mfg_date]"
                                                       value="{{ $modules['default_mfg_date'] ?? '' }}"
                                                       class="form-control">
                                            </div>
                                        @else
                                            <div class="col-lg-6 mb-2">
                                                <label>{{ __('Manufacturing Date') }}</label>
                                                <input type="month" name="stocks[0][mfg_date]"
                                                       value="{{ $modules['default_mfg_date'] ?? '' }}"
                                                       class="form-control">
                                            </div>
                                        @endif
                                    ...
                                    @if (is_module_enabled($modules, 'show_expire_date'))
                                        @if(empty($modules['expire_date_type']) || $modules['expire_date_type'] === 'dmy')
                                            <div class="col-lg-6 mb-2">
                                                ...
                                                <input type="date" name="stocks[0][expire_date]"
                                                       value="{{ $modules['default_expired_date'] ?? '' }}"
                                                       class="form-control">
                                            </div>
                                        @else
                                            <div class="col-lg-6 mb-2">
                                                <label>{{ __('Expire Date') }}</label>
                                                <input type="month" name="stocks[0][expire_date]"
                                                       value="{{ $modules['default_expired_date'] ?? '' }}"
                                                       class="form-control">
                                            </div>
                                        @endif
    ...
    @foreach($defaultPermissions as $key)
        @php
            // if $modules is not set, default to true
