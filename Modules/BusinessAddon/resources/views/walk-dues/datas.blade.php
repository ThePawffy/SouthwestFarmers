@foreach($walk_in_customers as $walk_in_customer)
    <tr>
        ...
        <td class="text-danger table-single-content">{{ currency_format($walk_in_customer->dueAmount, currency: business_currency()) }}</td>
        <td class="print-d-none table-single-content">
            <div class="dropdown table-action">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a href="{{ route('business.collect.walk.dues', ['id' => $walk_in_customer->id]) }}">
