...
@section('main_content')
    <div class="container-fluid">
                ...
                <form class="sales-header-form">
                    <div class="sales-purchese-header">
                        <div class="input-grid">
                            ...
                            <input type="datetime-local" name="purchaseDate" class="form-control" value="{{ \Carbon\Carbon::parse($purchase->purchaseDate)->format('Y-m-d\TH:i') }}">
                        </div>
                        <div class="input-grid">
                            <label> {{__('Previous Due')}} </label>
                            <input type="text" id="supplier_prev_due" value="{{ $purchase->party->due ?? '' }}" class="form-control" readonly>
                        </div>
                        ...
                        <div class="input-grid-invoice">
                            ...
                            <input type="text" name="invoiceNumber" value="{{ $purchase->invoiceNumber }}" class="form-control" placeholder="{{ __('Invoice no') }}." readonly>
                        </div>
                        <div class="select-customer-lg">
                            <select required name="party_id" id="supplier_id" class="form-select supplier-select choices-select" aria-label="Select Supplier">
                            ...
                            <a type="button" href="#supplier-create-modal" data-bs-toggle="modal">
                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_273_6059)">
                                        <path d="M11.9143 15.6286V14.1429C11.9143 13.3548 11.6013 12.599 11.044 12.0418C10.4868 11.4845 9.73099 11.1714 8.94291 11.1714H3.74291C2.95484 11.1714 2.19905 11.4845 1.6418 12.0418C1.08454 12.599 0.771484 13.3548 0.771484 14.1429V15.6286" stroke="white" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M6.34301 8.2C7.98409 8.2 9.31444 6.86964 9.31444 5.22857C9.31444 3.58749 7.98409 2.25714 6.34301 2.25714C4.70194 2.25714 3.37158 3.58749 3.37158 5.22857C3.37158 6.86964 4.70194 8.2 6.34301 8.2Z" stroke="white" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M14.8859 5.97144V10.4286" stroke="white" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M17.1144 8.20001H12.6572" stroke="white" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/>
                                    </g>
                                    <defs>
                                        <clipPath id="clip0_273_6059">
                                            <rect width="17.8286" height="17.8286" fill="white" transform="translate(0.0286865 0.0285645)"/>
                                        </clipPath>
                                    </defs>
                                </svg>
                            </a>
        ...
        <div class="grid sales-main-container">
                            ...
                            <div class="search-product">
                                ...
                                <div class="d-flex position-relative sale-pur-search">
                                    <svg class="search-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M21.3353 20.47L17.529 16.629C18.8014 15.106 19.5714 13.143 19.5714 11C19.5714 6.175 15.6819 2.25 10.9006 2.25C6.11922 2.25 2.22974 6.175 2.22974 11C2.22974 15.825 6.11922 19.75 10.9006 19.75C13.0242 19.75 14.9694 18.973 16.4786 17.689L20.2848 21.53C20.4295 21.676 20.6198 21.75 20.8101 21.75C21.0003 21.75 21.1906 21.677 21.3353 21.53C21.6256 21.238 21.6256 20.763 21.3353 20.47ZM3.71616 11C3.71616 7.002 6.93873 3.75 10.9006 3.75C14.8624 3.75 18.0849 7.002 18.0849 11C18.0849 14.998 14.8624 18.25 10.9006 18.25C6.93873 18.25 3.71616 14.998 3.71616 11Z" fill="#171717"></path>
                                    </svg>
                                    <input type="text" name="search" id="purchase_product_search" class="form-control search-input" placeholder="{{ __('Search items name...') }}">
                                    ...
                                    <a href="{{ route('business.products.create') }}" class="create-product">
                                        <svg width="28" height="28" viewBox="0 0 28 28" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path d="M13.8232 6V22.3333" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M5.65616 14.166H21.9895" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                    </a>
                                    @endif
                                </div>
                ...
                <div class="products-container">
                    <div class=" scroll-card">
                        <div
                            ...
                            id="products-list">
                            @include('businessAddon::purchases.product-list')
                        </div>
                    </div>
                </div>
            </div>
            <div class="sales-container">
                ...
                <form action="{{ route('business.purchases.update',$purchase->id) }}" method="post" enctype="multipart/form-data"
                      class="sales_purchase_form">
                    @csrf
                    @method('put')
                        ...
                        <div class="product-table">
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    @include('businessAddon::purchases.cart-list')
                                    </tbody>
                                </table>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                <div class="amount-info-container">
                                    ...
                                    <div class="row amount-container  align-items-center mb-2">
                                        ...
                                        <input type="text" name="note" class="form-control" value="{{ $purchase->meta['note'] ?? '' }}"
                                    ...
                                    <div class="row save-amount-container  align-items-center mb-2">
                                        ...
                                        <div class="col-6 w-100 d-flex justify-content-between gap-2">
                                            ...
                                            <input type="number" step="any" name="vat_amount" id="vat_amount" min="0"
                                                   ...
                                                   class="form-control right-start-input" placeholder="{{ __('0') }}" readonly>
                                        </div>
                                    </div>
                                    <div class="row save-amount-container  align-items-center mb-2">
                                        ...
                                        <div class="col-6 w-100 d-flex justify-content-between gap-2">
                                            ...
                                            <input type="number" step="any" name="discountAmount" id="discount_amount"
                                                   ...
                                                   min="0" class="form-control right-start-input" placeholder="{{ __('0') }}">
                                        </div>
                                    </div>
                                    <div class="row save-amount-container  align-items-center mb-2">
                                        ...
                                        <div class="col-12">
                                            <input type="number" step="any" name="shipping_charge" id="shipping_charge"
                                                   value="{{ $purchase->shipping_charge }}" class="form-control right-start-input" placeholder="{{ __('0') }}">
                                        </div>
                                    </div>
    ...
    @include('businessAddon::purchases.product-modal')
...
@push('modal')
    @include('businessAddon::purchases.calculator')
    @include('businessAddon::purchases.supplier-create')
@endpush
