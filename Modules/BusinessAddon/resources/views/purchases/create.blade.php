    ...
    <div class="container-fluid">
                ...
                <form class="sales-header-form">
                    <div class="sales-purchese-header">
                        <div class="input-grid">
                            ...
                            <input type="datetime-local" name="purchaseDate" class="form-control" value="{{ now()->format('Y-m-d\TH:i') }}">
                        </div>

                        <div class="input-grid">
                            <label> {{__('Previous Due')}} </label>
                            <input type="text" id="supplier_prev_due" class="form-control" readonly>
                        </div>
        ...
        <div class="grid sales-main-container">
            ...
            <div class="sales-container">
                ...
                <form action="{{ route('business.purchases.store') }}" method="post" enctype="multipart/form-data"
