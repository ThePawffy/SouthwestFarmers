                            ...
                            <table class="table table-striped bg-white border rounded">
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="opening_stock_by_purchase">{{ currency_format($opening_stock_by_purchase, currency: business_currency()) }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td  class="text-start">Opening Stock</td>
                                        <td id="opening_stock_by_sale">{{ currency_format($opening_stock_by_sale, currency: business_currency()) }}</td>
                                    </tr>
                                    <tr>
                            ...
                            <table class="table table-striped bg-white border rounded">
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="closing_stock_by_purchase">{{ currency_format($closing_stock_by_purchase, currency: business_currency())}}</td>
                                    </tr>
                                    <tr>
                                        <td class='text-start' colspan="2">(By purchase price)</td>
                                    </tr>
                                    <tr>
                                        <td class='text-start'>Closing stock</td>
                                        <td id="closing_stock_by_sale">{{ currency_format($closing_stock_by_sale, currency: business_currency()) }}</td>
                                    </tr>
                                    <tr>
                                        <td class='text-start' colspan="2">(By sale price)</td>
                                    </tr>
