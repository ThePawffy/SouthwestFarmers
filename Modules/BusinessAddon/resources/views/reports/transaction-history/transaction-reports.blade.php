            ...
            <div class="responsive-table m-0">
                <table class="table bg-striped" id="datatable">
                    ...
                    <tr>
                        ...
                        <th class="text-start striped-th">{{ __('Invoice Number') }}</th>
                        <th class="text-start striped-th">{{ __('Party Name') }}</th>
                        <th class="text-start striped-th">{{ __('Total Due') }}</th>
                        <th class="text-start striped-th">{{ __('Pay Due Amount') }}</th>
                        <th class="text-start striped-th">{{ __('Payment Type') }}</th>
                        <th class="text-start striped-th">{{ __('Payment Date') }}</th>
                    </tr>
                    </thead>
                    <tbody id="transactions-reports-data">
                        @include('businessAddon::reports.transaction-history.datas')
                    </tbody>
                </table>
            </div>
            <div class="mt-3">
