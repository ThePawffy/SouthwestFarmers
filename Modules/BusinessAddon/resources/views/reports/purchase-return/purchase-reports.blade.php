    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="responsive-table m-0">
                <table class="table bg-stripe " id="datatable">
                    <thead>
                        <tr>
                            <th class="striped-th">{{ __('SL') }}.</th>
                            <th class="striped-th">{{ __('Invoice No') }}</th>
                            <th class="striped-th">{{ __('Date') }}</th>
                            <th class="striped-th">{{ __('Name') }}</th>
                            <th class="striped-th">{{ __('Total') }}</th>
                            <th class="striped-th">{{ __('Paid') }}</th>
                            <th class="striped-th">{{ __('Return Amount') }}</th>
                        </tr>
                    </thead>
                    <tbody id="purchase-return-report-data">
                        @include('businessAddon::reports.purchase-return.datas')
                    </tbody>
                </table>
            </div>
            <div class="mt-3">
