            ...
            <div class="responsive-table m-0">
                <table class="table bg-striped" id="datatable">
                    ...
                    <tr>
                        ...
                        <th class="text-start striped-th">{{ __('Amount') }}</th>
                        <th class="text-start striped-th">{{ __('Category') }}</th>
                        <th class="text-start striped-th">{{ __('Expense For') }}</th>
                        <th class="text-start striped-th">{{ __('Payment Type') }}</th>
                        <th class="text-start striped-th">{{ __('Reference Number') }}</th>
                        <th class="text-start striped-th">{{ __('Expense Date') }}</th>
                    </tr>
                    </thead>
                    <tbody id="expense-reports-data">
                        @include('businessAddon::reports.expense.datas')
                    </tbody>
                </table>
            </div>
            <div class="mt-3">
