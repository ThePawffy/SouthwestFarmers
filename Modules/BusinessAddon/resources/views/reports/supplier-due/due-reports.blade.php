            ...
            <div class="responsive-table m-0">
                <table class="table bg-striped" id="datatable">
                    ...
                    <tr>
                        ...
                        <th class="text-start striped-th">{{ __('Email') }}</th>
                        <th class="text-start striped-th">{{ __('Phone') }}</th>
                        <th class="text-start striped-th">{{ __('Type') }}</th>
                        <th class="text-end striped-th">{{ __('Due Amount') }}</th>
                    </tr>
                    </thead>
                    <tbody id="supplier-due-reports-data">
                        @include('businessAddon::reports.supplier-due.datas')
                    </tbody>
                </table>
            </div>
            <div class="mt-3">
