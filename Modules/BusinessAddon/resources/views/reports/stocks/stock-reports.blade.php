            ...
            <div class="responsive-table m-0">
                <table class="table bg-striped" id="datatable">
                    ...
                    <tr>
                        ...
                        <th class="text-start striped-th">{{ __('Product') }}</th>
                        <th class="text-start striped-th">{{ __('Cost') }}</th>
                        <th class="text-start striped-th">{{ __('Qty') }}</th>
                        <th class="text-start striped-th">{{ __('Sale') }}</th>
                        <th class="text-start striped-th">{{ __('Stock Value') }}</th>
                    </tr>
                    </thead>
                    <tbody id="stock-reports-data">
                        @include('businessAddon::reports.stocks.datas')
                    </tbody>
                </table>
            </div>
            <div class="mt-3">
