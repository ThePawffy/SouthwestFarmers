            ...
            <div class="responsive-table m-0">
                <table class="table bg-striped" id="datatable">
                    ...
                    <tr>
                        ...
                        <th class="text-start striped-th">{{ __('Total Amount') }}</th>
                        <th class="text-start striped-th">{{ __('Discount Amount') }}</th>
                        <th class="text-start striped-th">{{ __('Paid Amount') }}</th>
                        <th class="text-start striped-th">{{ __('Due Amount') }}</th>
                        <th class="text-start striped-th">{{ __('Vat Amount') }}</th>
                        <th class="text-start striped-th">{{ __('Payment Type') }}</th>
                        <th class="text-start striped-th">{{ __('Sale Date') }}</th>
                    </tr>
                    </thead>
                    <tbody id="purchase-report-data">
                        @include('businessAddon::reports.purchase.datas')
                    </tbody>
                </table>
            </div>
            <div class="mt-3">
