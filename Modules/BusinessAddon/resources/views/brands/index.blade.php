                    ...
                    <table class="table bg-striped" id="datatable">
                        <thead>
                            <tr>
                                ...
                                <th class="striped-th">{{ __('Icon') }}</th>
                                <th class="text-start striped-th">{{ __('Brand Name') }}</th>
                        ...
                        <tbody id="business-brand-data">
                            @include('businessAddon::brands.datas')
                        </tbody>
                    </table>
                </div>
                <div class="mt-3">
...
@push('modal')
    ...
    @include('businessAddon::brands.create')
    @include('businessAddon::brands.edit')
@endpush
