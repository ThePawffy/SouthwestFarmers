                ...
                <form action="{{ route('business.purchase-returns.store') }}" method="post" enctype="multipart/form-data" class="ajaxform">
                    ...
                    <div class="mt-4 mb-3 order-form-section ">
                        <div class="row g-3">
                            <div class="col-lg-4">
                                ...
                                <input type="text" value="{{ $purchase->party->name ?? '' }}" class="form-control" placeholder="{{ __('Supplier Name') }}." readonly>
                            </div>
                            <div class="col-lg-4">
                                <label>{{ __('Date') }}</label>
                                    ...
                                    <tr data-max_qty="{{ $detail->quantities }}"
                                        ...
                                        <td class='text-center large-td'>
                                            <div class="d-flex align-items-center justify-content-center gap-3">
                                                ...
                                                <input type="number" name="return_qty[]" value="" class="custom-number-input return-qty" placeholder="0">
                    ...
                    <div class="col-lg-12 delete-cancel-group">
                        <div class="button-group text-center mt-5">
                            <a href="{{ route('business.purchases.index') }}" class="theme-btn border-btn m-2">{{ __('Cancel') }}</a>
